var AdminLTEHelper = {
    ...
    "initializeRecordGraphChart": function(model, graphJSON) {
        ...
        if (graphId in AdminLTEHelper.__recordGraphCharts) {
            AdminLTEHelper.__recordGraphCharts[graphId].destroy();
        }
        ...
        AdminLTEHelper.__recordGraphCharts[graphId] = new Chart(ctx, {
            type: 'line',
            data: {
                labels: labels,
                datasets: [{
    ...
    "setWidgetState": function (suffix, state) {
        ...
        AdminLTEHelper.setCookie(cookieName,state, 365);
    },
    "getWidgetState": function (suffix) {
        var controller = document.getElementById("controller").value;
        var cookieName = (`${controller}${suffix}`);
        return AdminLTEHelper.getCookie(cookieName);
    },
