    ...
    methods: {
        processLoadQueue: function () {
            ...
            if (!self.page.is_variables_loaded 
                ...
                && !self.page.is_adminlteusergroup_id_options_loaded
            ...
            if (!self.page.is_variables_loaded) {
                ...
                if (!self.page.is_files_loaded) {
                    ...
                    self.loadModelData();
                } else if (!self.page.is_adminlteusergroup_id_options_loaded) {
                    self.load_adminlteusergroup_id_options();
        ...
        load_files: function () {
            ...
            axios.get(AdminLTEHelper.getAPIURL("adminlteuser/get_files/" + this.current_id))
                .then(({ data }) => {
        ...
        loadModelData: function () {
            ...
            axios.get(AdminLTEHelper.getAPIURL("adminlteuser/get/" + this.current_id))
                .then(({ data }) => {
