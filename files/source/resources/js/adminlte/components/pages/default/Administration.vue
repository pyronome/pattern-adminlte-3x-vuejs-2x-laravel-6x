...
export default {
    ...
    methods: {
        ...
        load_source_widgets: function () {
            ...
            axios.get(AdminLTEHelper.getAPIURL("adminlte/get_source_widgets/" + source_group_id))
                .then(({ data }) => {
        ...
        submitLayoutForm: function () {
            ...
            self.LayoutForm.post(AdminLTEHelper.getAPIURL("adminlte/post_copy_widgets"))
                .then(({ data }) => {
                    self.$Progress.finish();
                    self.page.has_post_error = data.has_error;
                    self.page.post_message = data.error_msg;
