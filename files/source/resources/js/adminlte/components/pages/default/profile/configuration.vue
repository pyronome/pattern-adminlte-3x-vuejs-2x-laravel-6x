...
export default {
    ...
    methods: {
        ...
        loadModelData: function () {
            ...
            axios.get(AdminLTEHelper.getAPIURL("profile/get"))
                .then(({ data }) => {
                    ...
                    this.current_id = this.AdminLTEUserForm.id;
        ...
        submitForm: function () {
            var self = this;
            self.$Progress.start();
            self.AdminLTEUserForm.post(AdminLTEHelper.getAPIURL("profile/post"))
                .then(({ data }) => {
                    self.$Progress.finish();
        ...
        downloadFile: function (__key) {
            axios.get(AdminLTEHelper.getAPIURL("profile/download_file/uploaded/" + __key))
                .then(({ data }) => {
        ...
        downloadDefaultFile: function (__key) {
            axios.get(AdminLTEHelper.getAPIURL("profile/download_file/default/" + __key))
                .then(({ data }) => {
                    var a = document.createElement("a"); //Create <a>
                    a.href = data.url; //Image Base64 Goes here
                    a.download = data.filename; //File name Here
        ...
        loadData: function (callback) {
            ...
            axios.get(AdminLTEHelper.getAPIURL("profile/get_config_data/" + query))
                .then(({ data }) => {
        ...
        submitConfigForm: function () {
            ...
            axios.post( 
                    AdminLTEHelper.getAPIURL("profile/post_config_data"),
                    formData,
                    {
                        headers: {
