...
export default {
    ...
    methods: {
        ...
        loadPageVariables: function () {
            ...
            axios.get(AdminLTEHelper.getAPIURL("adminlte/get_page_variables/configuration"))
                .then(({ data }) => {
                    ...
                    let authorization = AdminLTEHelper.isUserAuthorized(self.page.variables, self.pagename, 'adminlteuser', 'read');
                    if (authorization.status) {
                        authorization = AdminLTEHelper.isUserAuthorized(self.page.variables, self.pagename, 'adminlteuser', 'update');
                    }
        ...
        downloadFile: function (__key) {
            axios.get(AdminLTEHelper.getAPIURL("adminlteusergroup/download_file/uploaded/" + __key + "/" + this.current_id))
                .then(({ data }) => {
        ...
        downloadDefaultFile: function (__key) {
            axios.get(AdminLTEHelper.getAPIURL("adminlteusergroup/download_file/default/" + __key + "/0"))
                .then(({ data }) => {
                    var a = document.createElement("a"); //Create <a>
                    a.href = data.url; //Image Base64 Goes here
                    a.download = data.filename; //File name Here
        ...
        loadData: function (callback) {
            ...
            axios.get(AdminLTEHelper.getAPIURL("adminlteusergroup/get_config_data/" + query))
                .then(({ data }) => {
        ...
        submitConfigForm: function () {
            ...
            axios.post( 
                    AdminLTEHelper.getAPIURL("adminlteusergroup/post_config_data"),
                    formData,
                    {
                        headers: {
