<template>
    <div class="content-wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover table-sm">
                                    <thead>
                                        <tr>
                                            <th>
                                                <button type="button"
                                                    id="button_sort_AdminLTELog_updated_at"
                                            ...
                                            <th>
                                                <button type="button"
                                                    id="button_sort_AdminLTELog_type"
                                                    class="button-table-sort"
                                                    @click="sort('type')">
                                                    <span>{{ $t("Type") }}</span>&nbsp;
                                                    <span class="sorting loading">
                                            ...
                                            <th>
                                                <button type="button"
                                                    id="button_sort_AdminLTELog_title"
                                                    class="button-table-sort"
                                                    @click="sort('title')">
                                                    <span>{{ $t("Record") }}</span>&nbsp;
                                                    <span class="sorting loading">
                                    ...
                                    <tbody id="'tbodyAdminLTELogRecordList'">
        ...
        <input type="hidden" id="controller" value="adminltelogs">
    </div>
</template>
...
export default {
    ...
    methods: {
             ...
             if (!self.page.is_variables_loaded) {
                ...
                if (!self.page.is_filter_options_loaded) {
                    ...
                    if (self.page.is_data_loaded) {
                        ...
                        self.loadData(function(){
                            AdminLTEHelper.setDefaultSortButton("button_sort_AdminLTELog_id");
                        });
                    }
                }
            }
        ...
        load_filter_options: function () {
			...
			axios.get(AdminLTEHelper.getAPIURL("adminltelogs/get_filter_options"))
                .then(({ data }) => {
        ...
        loadData: function (callback) {
            ...
            axios.get(AdminLTEHelper.getAPIURL("adminltelogs/get_recordlist/" + query + "&f=" + filter))
                .then(({ data }) => {
                    self.data = data;
        ...
        sort: function (variable) {
            AdminLTEHelper.activateSortLoader(`button_sort_AdminLTELog_${variable}`);
            ...
            var self = this;
            this.loadData(function() {
                AdminLTEHelper.deactivateSortLoader(`button_sort_AdminLTELog_${self.sort_variable}`, self.sort_direction)
            });
        },
