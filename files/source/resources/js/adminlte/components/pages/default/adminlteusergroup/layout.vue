...
export default {
    ...
    methods: {
        ...
        loadPageVariables: function () {
            ...
            axios.get(AdminLTEHelper.getAPIURL("adminlte/get_page_variables/" + self.pagename))
                .then(({ data }) => {
                   ...
                   let authorization = {};
                   if ("new" == self.id) {
                       authorization = AdminLTEHelper.isUserAuthorized(self.page.variables, self.pagename, 'adminlteusergroup', 'create');
                   } else {
                       authorization = AdminLTEHelper.isUserAuthorized(self.page.variables, self.pagename, 'adminlteusergroup', 'read');
                       if (authorization.status) {
                           authorization = AdminLTEHelper.isUserAuthorized(self.page.variables, self.pagename, 'adminlteusergroup', 'update');
                       }
                   }
        ...
        load_page_options: function () {
			...
			axios.get(AdminLTEHelper.getAPIURL("__layout/get_layout_page_options"))
                .then(({ data }) => {
        ...
        loadData: function () {
            ...
            axios.get(AdminLTEHelper.getAPIURL("adminlteusergroup/get_layout_data/" + self.usergroup_id))
                .then(({ data }) => {
        ...
        submitForm: function () {
            ...
            self.$Progress.start();
            self.LayoutForm.post(AdminLTEHelper.getAPIURL("adminlteusergroup/post_layout_data"))
                .then(({ data }) => {
