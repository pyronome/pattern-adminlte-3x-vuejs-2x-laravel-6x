...
export default {
    ...
    mounted() {
        ...
        self.contentContainerId = AdminLTEHelper.generateGUID("fileContentContainer");
    ...
    methods: {
        load_files: function(callback) {
            ...
            axios.get(AdminLTEHelper.getAPIURL("adminltemedia/get_file_contents/" + self.fileIds))
                .then(({ data }) => {
