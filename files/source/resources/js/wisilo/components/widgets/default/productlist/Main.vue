    ...
    <div class="widgetcomponent">
        <div class="widget-inner-container">
            ...
            <div style="display: grid;width: 100%;">
                <div class="row">
                    <div v-for="(row, row_index) in list" :key="row_index" class="col-lg-3 mb-4" style="padding: 10px;">
                        <div style="border: 1px solid #343a40;border-radius:10px;padding: 10px;min-height: 300px;">
                            <div v-for="(displaytext, column_index) in row.displaytexts" :key="column_index" v-html="displaytext" :style="row.styles[column_index]">
                            </div>
                        </div>
                    </div>
                </div>
