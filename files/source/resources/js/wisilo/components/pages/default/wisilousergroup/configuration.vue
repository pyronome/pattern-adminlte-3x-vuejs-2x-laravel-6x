        ...
        <div v-else>
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 v-html="WisiloUserGroupForm.title"></h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-12" v-show="page.variables.is_admin">
                            <router-link tag="a"
                                ...
                                :to="'/' + main_folder + '/wisilousergroup/layout/' + current_id"
...
export default {
    ...
    computed: {
        ...
        parameterSettingsURL() {
            let URL = '/' + this.main_folder + '/wisilousergroup';
            if (this.current_id > 0) {
                URL = URL + '/parametersettings/' + this.current_id;
            }
            return URL;
        },
    },
    methods: {
        ...
        load_files: function () {
            ...
            axios.get(WisiloHelper.getAPIURL("wisilousergroup/get_files/" + this.current_id))
                .then(({ data }) => {
        ...
        loadModelData: function () {
            ...
            axios.get(WisiloHelper.getAPIURL("wisilousergroup/get/" + this.current_id))
                .then(({ data }) => {
        ...
        renderForm: function() {
            ...
            iconPicker.on("change", function (e) {
                if (document.getElementById(this.current_id + "-value")) {
        ...
        downloadFile: function (__key) {
            axios.get(WisiloHelper.getAPIURL("wisilousergroup/download_file/uploaded/" + __key + "/" + this.current_id))
                .then(({ data }) => {
        ...
        downloadDefaultFile: function (__key) {
            axios.get(WisiloHelper.getAPIURL("wisilousergroup/download_file/default/" + __key + "/0"))
                .then(({ data }) => {
                    var a = document.createElement("a"); //Create <a>
                    a.href = data.url; //Image Base64 Goes here
                    a.download = data.filename; //File name Here
        ...
        loadData: function (callback) {
            ...
            axios.get(WisiloHelper.getAPIURL("wisilousergroup/get_config_data/" + query))
                .then(({ data }) => {
        ...
        submitConfigForm: function () {
            ...
            axios.post( 
                    WisiloHelper.getAPIURL("wisilousergroup/post_config_data"),
                    formData,
                    {
                        headers: {
