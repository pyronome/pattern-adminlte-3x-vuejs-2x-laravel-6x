                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a :href="backbuttonURL">{{ $t('WisiloUserGroup') }}</a></li>
...
export default {
    data() {
        return {
            ...
            page: {
                ...
                external_files: [
                    ("/js/wisilo/user_config_editor.js"),
    ...
    methods: {
        ...
        loadData: function () {
            ...
            axios.get(WisiloHelper.getAPIURL("wisilouserconfig/get_json/" + this.owner_group))
                .then(({ data }) => {
        ...
        load_listbykey: function () {
            ...
            axios.get(WisiloHelper.getAPIURL("wisilouserconfig/get_recordlist/" + this.owner_group))
                .then(({ data }) => {
        ...
        submitForm: function () {
            ...
            self.form.post(WisiloHelper.getAPIURL("wisilouserconfig/post_json")) */
            ...
            axios.post( 
                    WisiloHelper.getAPIURL("wisilouserconfig/post_json"),
                    formData,
                    {
                        headers: {
        ...
        parameterFormIsValid: function(callback) {
            ...
            self.validationForm.post(WisiloHelper.getAPIURL("wisilouserconfig/validate_item"))
                .then(({ data }) => {
                    self.$Progress.finish();
        ...
        downloadFile: function () {
            ...
            axios.get(WisiloHelper.getAPIURL("wisilouserconfig/download_file/default/" + __key))
                .then(({ data }) => {
