                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">{{ $t("WisiloUser Edit") }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-12 col-md-12 col-xs-12 searchable-container" data-search-text="wisilousergroup_id">
    ...
    methods: {
        processLoadQueue: function () {
            ...
            if (!self.page.is_variables_loaded 
                ...
                && !self.page.is_wisilousergroup_id_options_loaded
            ...
            if (!self.page.is_variables_loaded) {
                ...
                if (!self.page.is_files_loaded) {
                    ...
                    self.loadModelData();
                } else if (!self.page.is_wisilousergroup_id_options_loaded) {
                    self.load_wisilousergroup_id_options();
        ...
        renderForm: function() {
            ...
            $("#WisiloUserConfigFormContainer > .dropdownTabGroup").off('change').on('change', function () {
        ...
        loadPageVariables: function () {
            ...
            axios.get(WisiloHelper.getAPIURL("wisilo/get_page_variables/configuration"))
                .then(({ data }) => {
                    ...
                    let authorization = WisiloHelper.isUserAuthorized(self.page.variables, self.pagename, 'wisilouser', 'read');
                    if (authorization.status) {
                        authorization = WisiloHelper.isUserAuthorized(self.page.variables, self.pagename, 'wisilouser', 'update');
                    }
        ...
        load_files: function () {
            ...
            axios.get(WisiloHelper.getAPIURL("wisilouser/get_files/" + this.current_id))
                .then(({ data }) => {
        ...
        loadModelData: function () {
            ...
            axios.get(WisiloHelper.getAPIURL("wisilouser/get/" + this.current_id))
                .then(({ data }) => {
        ...
        downloadFile: function (__key) {
            axios.get(WisiloHelper.getAPIURL("wisilouser/download_file/uploaded/" + __key + "/" + this.current_id))
                .then(({ data }) => {
        ...
        downloadDefaultFile: function (__key) {
            axios.get(WisiloHelper.getAPIURL("wisilouser/download_file/default/" + __key + "/0"))
                .then(({ data }) => {
                    var a = document.createElement("a"); //Create <a>
                    a.href = data.url; //Image Base64 Goes here
                    a.download = data.filename; //File name Here
        ...
        loadData: function (callback) {
            ...
            axios.get(WisiloHelper.getAPIURL("wisilouser/get_config_data/" + query))
                .then(({ data }) => {
        ...
        submitConfigForm: function () {
            ...
            axios.post( 
                    WisiloHelper.getAPIURL("wisilouser/post_config_data"),
                    formData,
                    {
                        headers: {
