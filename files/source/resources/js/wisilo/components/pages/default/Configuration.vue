        ...
        <div v-else>
            ...
            <section class="content">
                <!-- <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <h4 class="form-part-header">Wisilo</h4>
                        </div>
                ...
                <div class="container-fluid"  id="WisiloConfigFormContainer" style="padding-bottom:100px;">
                </div>
...
export default {
    ...
    methods: {
        ...
        renderForm: function() {
            document.getElementById("WisiloConfigFormContainer").innerHTML = "";
            ...
            if (0 == self.list.length) {
                document.getElementById("WisiloConfigFormContainer").innerHTML = document.getElementById("noResultTemplate").innerHTML;
            }
            ...
            self.list.forEach(element => {
                ...
                if ("group" == element.type) {
                    if (0 == element.level) {
                        ...
                        document.getElementById("WisiloConfigFormContainer").innerHTML += elementHTML;
        ...
        downloadFile: function (__key) {
            axios.get(WisiloHelper.getAPIURL("wisiloconfig/download_file/uploaded/" + __key))
                .then(({ data }) => {
        ...
        loadData: function (callback) {
            ...
            axios.get(WisiloHelper.getAPIURL("wisiloconfig/getlist/" + query))
                .then(({ data }) => {
                    ...
                    callback();
                    WisiloHelper.cleanCheckedBoxes('WisiloConfig');
                });
        },
        ...
        sort: function (variable) {
            WisiloHelper.activateSortLoader(`button_sort_WisiloConfig_${variable}`);
            ...
            var self = this;
            this.loadData(function() {
                WisiloHelper.deactivateSortLoader(`button_sort_WisiloConfig_${self.sort_variable}`, self.sort_direction)
            });
        },
        ...
        deleteSelectedRows: function(sender, model) {
            ...
            Vue.swal.fire({
                ...
                if (result.isConfirmed) {
                    self.formDelete.selected_ids = WisiloHelper.getTableSelectedRowIds("WisiloConfig");
        ...
        submitDeleteForm: function () {
            var self = this;
            self.$Progress.start();
            self.formDelete.post(WisiloHelper.getAPIURL("wisiloconfig/delete"))
                .then(({ data }) => {
                    self.$Progress.finish();
        ...
        submitConfigForm: function () {
            ...
            axios.post( 
                    WisiloHelper.getAPIURL("wisiloconfig/post_config_data"),
                    formData,
                    {
                        headers: {
