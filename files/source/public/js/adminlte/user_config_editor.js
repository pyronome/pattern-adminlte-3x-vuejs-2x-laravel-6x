    ...
    $.fn.sortableListsToJson = function (){
        ...
        $(this).children('li').each(function () {
            ...
            var object = {
                ...
                "show_on_group" : li.data("show_on_group"),
                "show_on_user" : li.data("show_on_user"),
                "show_on_profile" : li.data("show_on_profile"),
            };
...
function MenuEditor(idSelector, options) {
    ...
    /* PRIVATE METHODS */
    function copy_data_to_object(data) {
        var objectData = {
            "system" : data["system"],
            "owner" : data["owner"],
            ...
            "option_titles" : data["option_titles"],
            "option_values" : data["option_values"],
            "required" : data["required"],
            "step" : data["step"],
            "title" : data["title"],
            "toggle_elements" : data["toggle_elements"],
            "type" : data["type"],
            "url" : data["url"],
            "value" : data["value"],
            "hint" : data["hint"],
            "description" : data["description"],
            "large_screen_size" : data["large_screen_size"],
            "medium_screen_size" : data["medium_screen_size"],
            "small_screen_size" : data["small_screen_size"],
            "max_selection" : data["max_selection"],
            "min_selection" : data["min_selection"],
            "expression" : data["expression"],
            "message" : data["message"],
            "show_on_group" : data["show_on_group"],
            "show_on_user" : data["show_on_user"],
    ...
    function collect_data() {
        var objectData = {
            ...
            "default_value" : getItemDefaultValue(document.getElementById("type").value),
            ...
            "show_on_group" : document.getElementById("show_on_group").checked,
            "show_on_user" : document.getElementById("show_on_user").checked,
            "show_on_profile" : document.getElementById("show_on_profile").checked,
        }
    ...
    function copyItem($item) {
        ...
        var objectData = copy_data_to_object(copyingData);
        objectData["basekey"] = objectData["basekey"] + "copy";
        objectData["__key"] = objectData["__key"] + "copy";
        objectData["title"] = objectData["title"] + " (Copy)";
    ...
    function copyChildren(children, parentKey) {
        ...
        for (let index = 0; index < children.length; index++) {
            ...
            objectData = copy_data_to_object(copyingData);
            objectData["__key"] = (parentKey + "." + objectData["basekey"]);
            objectData["__parent"] = parentKey;
    ...
    this.update = function(){
        ...
        var objectData = collect_data();
        objectData["basekey"] = baseKey;
        objectData["__key"] = newKey;
    ...
    this.getChildrenData = function(element) {
        ...
        for (let index = 0; index < arrLi.length; index++) {
            ...
            newObject = copy_data_to_object($(li).data());
    ...
    this.updateChildren = function(children) {
        ...
        children.forEach(element => {
            objectData = copy_data_to_object(element);
    ...
    this.add = function(){
        ...
        var objectData = collect_data();
        objectData["owner"] = 0;
        objectData["is_owner"] = 1;
        objectData["editable"] = 1;
        objectData["basekey"] = baseKey;
        objectData["__key"] = newKey;
        objectData["__parent"] = newParentKey;
        objectData["title"] = newTitle;
    ...
    function getItemDefaultValue(type) {
        var default_val = "";
