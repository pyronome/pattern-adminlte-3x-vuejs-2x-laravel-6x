...
QueryBuilder.OPERATORS = {
    ...
    is_integer:          { type: 'is_integer',          nb_inputs: 0, multiple: false, apply_to: ['string', 'number', 'datetime', 'boolean'] },
    is_not_integer:      { type: 'is_not_integer',      nb_inputs: 0, multiple: false, apply_to: ['string', 'number', 'datetime', 'boolean'] },
    is_numeric:          { type: 'is_numeric',          nb_inputs: 0, multiple: false, apply_to: ['string', 'number', 'datetime', 'boolean'] },
    is_not_numeric:      { type: 'is_not_numeric',      nb_inputs: 0, multiple: false, apply_to: ['string', 'number', 'datetime', 'boolean'] },
    matching_regex:          { type: 'matching_regex',          nb_inputs: 1, multiple: false, apply_to: ['string', 'number', 'datetime', 'boolean'] },
    not_matching_regex:      { type: 'not_matching_regex',      nb_inputs: 1, multiple: false, apply_to: ['string', 'number', 'datetime', 'boolean'] }
};
...
QueryBuilder.defaults({
    operatorOpposites: {
        ...
        'is_not_numeric':       'is_numeric',
        'matching_regex':       'not_matching_regex',
        'not_matching_regex':       'matching_regex'
    },
...
QueryBuilder.defaults({
    mongoOperators: {
        ...
        is_integer:          function(v) { return null; },
        is_not_integer:      function(v) { return { '$nn': null }; },
        is_numeric:          function(v) { return null; },
        is_not_numeric:      function(v) { return { '$nn': null }; },
        matching_regex:            function(v) { return v[0]; },
        not_matching_regex:        function(v) { return { '$nn': v[0] }; }
        // @formatter:on
    },
    ...
    mongoRuleOperators: {
        ...
        $nn: function(v) {
            ...
            return {
                'val': v,
                'op': v === null ? 'is_not_integer' : (v === '' ? 'is_not_numeric' : 'not_matching_regex')
            };
        },
        $regex: function(v) {
            v = v.$regex;
...
QueryBuilder.regional['en'] = {
  ...
  "operators": {
    ...
    "not_matching_regex": "not matching regex"
  },
  "errors": {
